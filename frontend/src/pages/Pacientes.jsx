      ...
      <Modal open={modalOpen} onClose={() => { setModalOpen(false); setEditando(null); }} title={editando ? "Editar Paciente" : "Novo Paciente"}>
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="block text-sm font-medium text-[#374151] mb-1">CPF</label>
              <input {...register("cpf")} className="w-full px-3 py-2 rounded-lg border border-[#d1d5db] text-sm focus:ring-2 focus:ring-[#8ba888]/40 focus:border-[#8ba888]" />
            </div>
            <div>
              <label className="block text-sm font-medium text-[#374151] mb-1">Nascimento</label>
              <input type="date" {...register("data_nascimento")} className="w-full px-3 py-2 rounded-lg border border-[#d1d5db] text-sm focus:ring-2 focus:ring-[#8ba888]/40 focus:border-[#8ba888]" />
            </div>
          </div>
          <div className="grid grid-cols-2 gap-3">
            <div>
