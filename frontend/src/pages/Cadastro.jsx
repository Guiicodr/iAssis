...
export default function Cadastro() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-zinc-950 p-4 relative overflow-hidden bg-glow">
      <div className="absolute top-20 right-10 size-24 rounded-full bg-emerald-500/5 blur-3xl animate-float" />
      <div className="absolute bottom-20 left-10 size-32 rounded-full bg-emerald-500/5 blur-3xl animate-float-delayed" />
      <div className="w-full max-w-sm relative z-10">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="bg-zinc-900/80 backdrop-blur-sm rounded-xl border border-zinc-800 p-6 space-y-4 animate-slide-up">
